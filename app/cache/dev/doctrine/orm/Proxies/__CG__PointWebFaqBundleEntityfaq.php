...
namespace Proxies\__CG__\PointWeb\FaqBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class faq extends \PointWeb\FaqBundle\Entity\faq implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PointWeb\\FaqBundle\\Entity\\faq' . "\0" . 'id', '' . "\0" . 'PointWeb\\FaqBundle\\Entity\\faq' . "\0" . 'title', '' . "\0" . 'PointWeb\\FaqBundle\\Entity\\faq' . "\0" . 'answer', '' . "\0" . 'PointWeb\\FaqBundle\\Entity\\faq' . "\0" . 'online', '' . "\0" . 'PointWeb\\FaqBundle\\Entity\\faq' . "\0" . 'position', '' . "\0" . 'PointWeb\\FaqBundle\\Entity\\faq' . "\0" . 'createDate', '' . "\0" . 'PointWeb\\FaqBundle\\Entity\\faq' . "\0" . 'updateDate'];
        }
