...
namespace Proxies\__CG__\PointWeb\GalleryBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Gallery extends \PointWeb\GalleryBundle\Entity\Gallery implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PointWeb\\GalleryBundle\\Entity\\Gallery' . "\0" . 'id', '' . "\0" . 'PointWeb\\GalleryBundle\\Entity\\Gallery' . "\0" . 'title', '' . "\0" . 'PointWeb\\GalleryBundle\\Entity\\Gallery' . "\0" . 'description', '' . "\0" . 'PointWeb\\GalleryBundle\\Entity\\Gallery' . "\0" . 'online', 'pictures', '' . "\0" . 'PointWeb\\GalleryBundle\\Entity\\Gallery' . "\0" . 'position', '' . "\0" . 'PointWeb\\GalleryBundle\\Entity\\Gallery' . "\0" . 'updateDate', '' . "\0" . 'PointWeb\\GalleryBundle\\Entity\\Gallery' . "\0" . 'createDate'];
        }

        return ['__isInitialized__', '' . "\0" . 'PointWeb\\GalleryBundle\\Entity\\Gallery' . "\0" . 'id', '' . "\0" . 'PointWeb\\GalleryBundle\\Entity\\Gallery' . "\0" . 'title', '' . "\0" . 'PointWeb\\GalleryBundle\\Entity\\Gallery' . "\0" . 'description', '' . "\0" . 'PointWeb\\GalleryBundle\\Entity\\Gallery' . "\0" . 'online', '' . "\0" . 'PointWeb\\GalleryBundle\\Entity\\Gallery' . "\0" . 'position', '' . "\0" . 'PointWeb\\GalleryBundle\\Entity\\Gallery' . "\0" . 'updateDate', '' . "\0" . 'PointWeb\\GalleryBundle\\Entity\\Gallery' . "\0" . 'createDate'];
    }
