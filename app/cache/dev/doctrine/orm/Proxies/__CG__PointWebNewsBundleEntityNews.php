...
class News extends \PointWeb\NewsBundle\Entity\News implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'id', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'title', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'resum', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'description', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'position', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'online', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'layout', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'startDate', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'endDate', 'pictures', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'updateDate', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'createDate'];
        }

        return ['__isInitialized__', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'id', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'title', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'resum', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'description', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'position', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'online', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'layout', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'startDate', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'endDate', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'updateDate', '' . "\0" . 'PointWeb\\NewsBundle\\Entity\\News' . "\0" . 'createDate'];
    }
