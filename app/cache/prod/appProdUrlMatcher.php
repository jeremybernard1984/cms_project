    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/admin/map')) {
            ...
            if (preg_match('#^/admin/map/(?P<page>[^/]++)/list$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_map')), array (  '_controller' => 'PointWeb\\MapBundle\\Controller\\MapController::indexAction',  'page' => 1,));
            }
        ...
        if (0 === strpos($pathinfo, '/admin/contact')) {
            // admin_contact
            if (preg_match('#^/admin/contact/(?P<page>[^/]++)/list$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_contact')), array (  '_controller' => 'PointWeb\\AppBundle\\Controller\\ContactController::indexAction',  'page' => 1,));
            }
