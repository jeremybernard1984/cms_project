...
class __TwigTemplate_14c3ee17ff6ed3a05c749a9c316f2ea6b9394e1ba5c03f23ed465495c70e79fa extends Twig_Template
{
    ...
    {
        $__internal_d6f5be77a395a87d479c885026326550ee092b7f3210f241c95c954a4696363b = $this->env->getExtension("native_profiler");
        $__internal_d6f5be77a395a87d479c885026326550ee092b7f3210f241c95c954a4696363b->enter($__internal_d6f5be77a395a87d479c885026326550ee092b7f3210f241c95c954a4696363b_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "PointWebProductBundle:Category:sub_cat_table.html.twig"));
    ...
    <tr style=\"margin: 10px\">
        ...
        if (($this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "lvl", array()) != 0)) {
            ...
            <td style=\"width: 3%\" data-toggle=\"tooltip\" data-placement=\"left\" title=\"Descendre\">
                <a href=\"";
            // line 43
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_category_down", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id", array()))), "html", null, true);
            echo "\">
            ...
            <td style=\"width: 3%\" data-toggle=\"tooltip\" data-placement=\"left\" title=\"monter\">
                <a href=\"";
            // line 48
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_category_up", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id", array()))), "html", null, true);
            echo "\">
...
";
        ...
        $__internal_d6f5be77a395a87d479c885026326550ee092b7f3210f241c95c954a4696363b->leave($__internal_d6f5be77a395a87d479c885026326550ee092b7f3210f241c95c954a4696363b_prof);
...
/*                         <img  height="30" alt="{{ pictures[entity.id][0].name }}" src="{{ asset(pictures[entity.id][0].getWebPath(base)) }}" data-image="{{ asset(pictures[entity.id][0].getWebPath(base)) }}">*/
/*                     </a>*/
/*                 {% else %}*/
/*                     -*/
/*                 {% endif %}*/
/*         </td>*/
/*         <td class="titleTable">*/
/*             <a href="{{ path('admin_category_edit', { 'id': entity.id }) }}">{{ entity.id }} - {{ entity.title }}</a>*/
/*         </td>*/
/*         {% if entity.lvl != 0 %}*/
/*             <td style="width: 15%">*/
/*                 <div class="btn-group">*/
...
/*             </td>*/
/*             <td style="width: 3%" data-toggle="tooltip" data-placement="left" title="Descendre">*/
/*                 <a href="{{ path('admin_category_down', {'id': entity.id}) }}">*/
/*                     <i class="fa fa-long-arrow-down" ></i>*/
/*                 </a>*/
/*             </td>*/
/*             <td style="width: 3%" data-toggle="tooltip" data-placement="left" title="monter">*/
/*                 <a href="{{ path('admin_category_up', {'id': entity.id}) }}">*/
/*                     <i class="fa fa-long-arrow-up" ></i>*/
/*                 </a>*/
/*             </td>*/
/*         {% else %}*/
