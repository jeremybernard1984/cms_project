...
namespace Proxies\__CG__\PointWeb\EcommerceBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Media extends \PointWeb\EcommerceBundle\Entity\Media implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'PointWeb\\EcommerceBundle\\Entity\\Media' . "\0" . 'id', '' . "\0" . 'PointWeb\\EcommerceBundle\\Entity\\Media' . "\0" . 'updateAt', '' . "\0" . 'PointWeb\\EcommerceBundle\\Entity\\Media' . "\0" . 'name', '' . "\0" . 'PointWeb\\EcommerceBundle\\Entity\\Media' . "\0" . 'path', 'file');
        }
