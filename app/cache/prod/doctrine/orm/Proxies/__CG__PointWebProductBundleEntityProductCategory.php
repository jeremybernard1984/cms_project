 ...
 */
class ProductCategory extends \PointWeb\ProductBundle\Entity\ProductCategory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\ProductCategory' . "\0" . 'id', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\ProductCategory' . "\0" . 'title', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\ProductCategory' . "\0" . 'lft', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\ProductCategory' . "\0" . 'lvl', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\ProductCategory' . "\0" . 'rgt', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\ProductCategory' . "\0" . 'root', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\ProductCategory' . "\0" . 'parent', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\ProductCategory' . "\0" . 'children', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\ProductCategory' . "\0" . 'description', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\ProductCategory' . "\0" . 'products', 'pictures', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\ProductCategory' . "\0" . 'online'];
        }

        return ['__isInitialized__', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\ProductCategory' . "\0" . 'id', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\ProductCategory' . "\0" . 'title', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\ProductCategory' . "\0" . 'lft', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\ProductCategory' . "\0" . 'lvl', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\ProductCategory' . "\0" . 'rgt', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\ProductCategory' . "\0" . 'root', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\ProductCategory' . "\0" . 'parent', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\ProductCategory' . "\0" . 'children', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\ProductCategory' . "\0" . 'description', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\ProductCategory' . "\0" . 'products', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\ProductCategory' . "\0" . 'online'];
    }
     ...
     * {@inheritDoc}
     */
    public function setParent(\PointWeb\ProductBundle\Entity\ProductCategory $parent = NULL)
    {
     ...
     * {@inheritDoc}
     */
    public function addChildren(\PointWeb\ProductBundle\Entity\ProductCategory $children)
    {
